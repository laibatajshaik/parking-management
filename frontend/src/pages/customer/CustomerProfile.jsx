...
export default function CustomerProfile({ currentUser, isPremiumActive, premiumPlanInfo, onNavigateToPlans }) {
  ...
  return (
    <div className="pw-screen-container" style={{ display: "flex", flexDirection: "column", gap: "22px" }}>
      {isPremiumActive ? (
        <div style={{ background: "linear-gradient(135deg, #FEF9C3 0%, #FEF08A 50%, #FDE047 100%)", border: "1.5px solid #EAB308", borderRadius: "14px", padding: "18px 24px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "16px" }}>
        ...
        <div style={{ background: "#f0fdfa", border: "1.5px solid #ccfbf1", borderRadius: "14px", padding: "18px 24px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "16px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
            ...
            <div>
              <h3 style={{ fontSize: "1.05rem", fontWeight: 800, color: "#0f172a", margin: 0 }}>Unlock Gold VIP Priority Membership</h3>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1.3fr", gap: "20px" }}>
        <div style={{ background: "#ffffff", borderRadius: "14px", border: "1px solid #e2e8f0", padding: "22px", boxShadow: "0 2px 8px rgba(15,23,42,0.04)" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "16px", paddingBottom: "10px", borderBottom: "1px solid #f1f5f9" }}>
            ...
            <h4 style={{ fontSize: "1.02rem", fontWeight: 800, color: "#0f172a", margin: 0 }}>Account Information</h4>
          </div>
        ...
        <div style={{ background: "#ffffff", borderRadius: "14px", border: "1px solid #e2e8f0", padding: "22px", boxShadow: "0 2px 8px rgba(15,23,42,0.04)", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
          <div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px", paddingBottom: "10px", borderBottom: "1px solid #f1f5f9" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                ...
                <h4 style={{ fontSize: "1.02rem", fontWeight: 800, color: "#0f172a", margin: 0 }}>Saved Vehicle Garage</h4>
              </div>

              <button
                type="button"
                onClick={() => setIsAddVehicleOpen(true)}
                style={{ background: isPremiumActive ? "#FDF0CD" : "#f0fdfa", border: isPremiumActive ? "1px solid #C99A2E" : "1px solid #ccfbf1", color: isPremiumActive ? "#713F12" : "#0d9488", padding: "6px 12px", borderRadius: "8px", fontSize: "0.78rem", fontWeight: 800, cursor: "pointer", display: "inline-flex", alignItems: "center", gap: "4px" }}
              >
                <Plus size={14} />
              ...
              {savedVehicles.map((veh) => (
                ...
                >
                  <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                    <div style={{ width: "36px", height: "36px", borderRadius: "8px", background: isPremiumActive ? "#FDF0CD" : "#f0fdfa", display: "flex", alignItems: "center", justifyContent: "center" }}>
                      {getVehicleIcon(veh.type)}
                    </div>
                    <div>
                      <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                        <span style={{ fontSize: "0.95rem", fontWeight: 900, color: "#0f172a" }}>{veh.plate}</span>
                        {veh.isDefault && (
                  ...
                  <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
                    {!veh.isDefault && (
                      <button
                        ...
                        style={{ background: "transparent", border: "1px solid #cbd5e1", borderRadius: "6px", padding: "4px 8px", fontSize: "0.72rem", color: "#475569", cursor: "pointer", fontWeight: 600 }}
                      >
                        Set Default
                      </button>
                    )}
                    <button
                      ...
                      style={{ background: "#fef2f2", border: "1px solid #fecaca", borderRadius: "6px", padding: "6px", color: "#ef4444", cursor: "pointer" }}
          ...
          <div style={{ marginTop: "16px", padding: "12px", background: "#f8fafc", borderRadius: "8px", border: "1px solid #e2e8f0", fontSize: "0.78rem", color: "#64748b" }}>
      ...
      {isAddVehicleOpen && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(15, 23, 42, 0.6)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 9999, backdropFilter: "blur(4px)", padding: "16px" }}>
          <div style={{ background: "#ffffff", borderRadius: "14px", padding: "24px", maxWidth: "420px", width: "100%", boxShadow: "0 20px 40px rgba(0,0,0,0.2)" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px" }}>
              <h3 style={{ fontSize: "1.1rem", fontWeight: 800, color: "#0f172a", margin: 0 }}>Add Vehicle to Garage</h3>
              <button
                type="button"
